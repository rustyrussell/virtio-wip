...
A memory balloon driver MUST conform to the following normative statements:
...
\subsection{Memory Balloon Device Conformance}\label{sec:Conformance / Device Conformance / Memory Balloon Device Conformance}

A memory balloon device MUST conform to the following normative statements:
